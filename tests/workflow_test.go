...
// TestWorkflowRunCommand tests the workflow run command
...
// TestWorkflowRunWithPromptCommand tests the workflow run command with prompt flag
func disable_TestWorkflowRunWithPromptCommand(t *testing.T) {
	// Create a valid YAML file for testing
	validAgentYAML := `---
apiVersion: maestro/v1alpha1
kind: Agent
...
// TestWorkflowServeCommand tests the workflow serve command
func TestWorkflowServeCommand(t *testing.T) {
	// Create a valid YAML file for testing
	validAgentYAML := `---
apiVersion: maestro/v1alpha1
kind: Agent
...
// TestWorkflowDeployCommand tests the workflow deploy command
...
// TestWorkflowHelpCommand tests the workflow help command
func TestWorkflowHelpCommand(t *testing.T) {
